...
const HeroSection = () => {
  return (
    <div id="home" className="my-container my-10">
          ...
          <div className="mt-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <p className="text-lg flex items-center gap-2">
                <FontAwesomeIcon icon={faCheckSquare} className="text-green-500" /> Efficient Performance
              </p>
              <p className="text-lg flex items-center gap-2">
                <FontAwesomeIcon icon={faCheckSquare} className="text-green-500" /> Responsive Layout
              </p>
              <p className="text-lg flex items-center gap-2">
                <FontAwesomeIcon icon={faCheckSquare} className="text-green-500" /> Neat & Clean Code
              </p>
              <p className="text-lg flex items-center gap-2">
                <FontAwesomeIcon icon={faCheckSquare} className="text-green-500" /> High-Code Readability
              </p>
            </div>
          </div>
